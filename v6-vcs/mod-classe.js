exports.migraClasse = function(orgCatalog, legCatalog, prefixList, classe)
{
                                        ...
                                        for(var p=0, len = parts.length; p<len; p++)
                                        {
                                            if(parts[p]){
                                                ...
                                                if(orgCatalog.indexOf(parts[p])!= -1){
                                                    var i = orgCatalog.indexOf(parts[p])
                                                    var prefixo = prefixList[i]
                                ...
                                for(var d=0, len = donos.length; d<len; d++)
                                {
                                    if(donos[d])
                                        ...
                                        if(orgCatalog.indexOf(donos[d])!= -1){
                                            var i = orgCatalog.indexOf(donos[d])
                                            var prefixo = prefixList[i]
                    ...
                    if(jsonObj['Código do processo relacionado']){
                        ...
                        if(procRefsSplit.length != procTiposSplit.length) {
                            ...
                            for(var p=0; p<len; p++)
                            {
                                ...
                                else if (procTiposSplit[p].startsWith(/\s*Suplement.?\s*de/)){
                                    classTriples += "\t:eSuplementoDe " + ":c" + procRefsSplit[p] + " ;\n"
                                }
                                else if (procTiposSplit[p].startsWith(/\s*Suplement.?\s*para/)){
